document.addEventListener('DOMContentLoaded', function () {
    ...
    const productName = 'Little Tweed Jacket'; // Tên sản phẩm từ tệp HTML
    const price = 2590000; // Giá sản phẩm (đơn vị: đồng)
    const productImage = '../images/product/sp2.webp'; // Đường dẫn ảnh sản phẩm
