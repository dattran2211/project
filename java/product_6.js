document.addEventListener('DOMContentLoaded', function () {
    ...
    const productName = 'Đàm cổ đức phối đai'; // Tên sản phẩm từ tệp HTML
    const price = 25900000; // Giá sản phẩm (đơn vị: đồng)
    const productImage = '../images/product/sp6.webp'; // Đường dẫn ảnh sản phẩm
