document.addEventListener('DOMContentLoaded', function () {
    ...
    const productName = 'Chân váy bút chì Tweed Muse'; // Tên sản phẩm từ tệp HTML
    const price = 990000; // Giá sản phẩm (đơn vị: đồng)
    const productImage = '../images/product/sp3.webp'; // Đường dẫn ảnh sản phẩm
