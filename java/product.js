document.addEventListener('DOMContentLoaded', function () {
    ...
    const productName = 'Đầm Tuysi cổ đức Attina 2 lớp'; // Tên sản phẩm từ tệp HTML
    const price = 2290000; // Giá sản phẩm (đơn vị: đồng)
    const productImage = '../images/product/sp1.webp'; // Đường dẫn ảnh sản phẩm
