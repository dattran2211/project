document.addEventListener('DOMContentLoaded', function () {
    ...
    const productName = 'Chân váy layer chữ A phối đai'; // Tên sản phẩm từ tệp HTML
    const price = 1290000; // Giá sản phẩm (đơn vị: đồng)
    const productImage = '../images/product/sp5.webp'; // Đường dẫn ảnh sản phẩm
